    ...
    <tr>
        ...
        <td class="subelements">
            <input type="radio" name="resizing" id="tinymce_resize1" value="yes"
                {if $module_settings.resizing == "true"}checked{/if} /> <label for="tinymce_resize1">{$LANG.word_yes}</label>
            <input type="radio" name="resizing" id="tinymce_resize2" value="no"
                {if $module_settings.resizing == ""}checked{/if} /> <label for="tinymce_resize2">{$LANG.word_no}</label>
        </td>
    </tr>
    </table>
